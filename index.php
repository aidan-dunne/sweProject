...
<body>
	...
	<main>
		<section class="pageContentMain">
			<h2>Welcome - your job search starts here!</h2>
			...
			and more efficiently find internships that are perfect for you. Additionally, our Companies and Programs page provides a list of companies 
			that offer internship programs at which Truman students have been successful at in the past.</p>
			<p>Our Research Experiences for Undergraduates (REU) page offers an explanation of what REUs are, why you may want to consider one
			over an internship, and provides a link to the National Science Foundation's REU database.</p>
